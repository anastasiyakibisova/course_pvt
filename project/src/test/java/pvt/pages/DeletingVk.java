...
public class DeletingVk {
	...
	@Test
	public void testDelet() throws ClientProtocolException, URISyntaxException, IOException  {
        ...
        String str = vk.deletePost(inform.getToken(),inform.getNumber(),number);
